 ...
 * @version v1.0.2 - 2016-02-09 * @link https://github.com/jacobscarter/angular-feedback
            ...
            (function($){
                ...
                $.feedback = function(options) {
                    ...
                    var settings = $.extend({
                            ...
                            initButtonText:         'Send us Feedback',
                            strokeStyle:            'black',
                            shadowColor:            'black',
                            shadowOffsetX:          1,
                            shadowOffsetY:          1,
                            ...
                            tpl: {
                                ...
                                highlighter:    '<div id="feedback-highlighter"><h2><i class="fa fa-comment fa-2x"></i> Feedback <small>Help us improve our product</small></h2><p>You can move this box if it\'s in the way.</p><button class="feedback-sethighlight feedback-active"><span>Highlight</span></button><label>Click and drag on the page to highlight areas relevant to your feedback.</label><button class="feedback-setblackout"><span>Black out</span></button><label class="lower">Click and drag on the page to black out any personal information.</label><div class="feedback-buttons"><button id="feedback-highlighter-next" class="feedback-next-btn feedback-btn-gray">Next</button><button id="feedback-highlighter-back" class="feedback-back-btn feedback-btn-gray">Back</button></div><div class="feedback-wizard-close"></div></div>',
                                overview:       '<div id="feedback-overview"><h2><i class="fa fa-comment fa-2x"></i> Feedback <small>Help us improve our product</small></h2><div id="feedback-overview-description"><div id="feedback-overview-description-text"><h3>Description</h3><h3 class="feedback-additional">Additional info</h3><div id="feedback-additional-none"><span>None</span></div><div id="feedback-browser-info"><span>Browser Info</span></div><div id="feedback-page-info"><span>Page Info</span></div><div id="feedback-page-structure"><span>Page Structure</span></div></div></div><div id="feedback-overview-screenshot"><h3>Screenshot</h3></div><div class="feedback-buttons"><button id="feedback-submit" class="feedback-submit-btn">Submit</button><button id="feedback-overview-back" class="feedback-back-btn feedback-btn-gray">Back</button></div><div id="feedback-overview-error">Please enter a description.</div><div class="feedback-wizard-close"></div></div>',
                                submitSuccess:  '<div id="feedback-submit-success"><h2><i class="fa fa-comment fa-2x"></i> Feedback</h2><p>Thank you for your feedback. We value every piece of feedback we receive.</p><p>We cannot respond individually to every one, but we will use your comments as we strive to improve your experience.</p><button class="feedback-close-btn feedback-btn-blue">OK</button><div class="feedback-wizard-close"></div></div>',
                                submitError:    '<div id="feedback-submit-error"><h2><i class="fa fa-comment fa-2x"></i> Feedback</h2><p>Sadly an error occured while sending your feedback. Please try again.</p><button class="feedback-close-btn feedback-btn-blue">OK</button><div class="feedback-wizard-close"></div></div>'
                            },
                            onClose:                function() {},
